...
"""Verify that starting indiancoin with -h works as expected."""
import subprocess

from test_framework.test_framework import IndianCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(IndianCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start indiancoin with -h for help text")
        ...
        self.log.info("Start indiancoin with -version for version information")
