...
class RawTransactionsTest(IndianCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid indiancoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid indiancoin address" in e.error['message'])
