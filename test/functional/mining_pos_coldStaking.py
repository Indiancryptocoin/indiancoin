...
from test_framework.indiancoin_node import IndianCoinTestNode
...
class INDIANCOIN_ColdStakingTest(IndianCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(IndianCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 IND from the pot)
...
if __name__ == '__main__':
    INDIANCOIN_ColdStakingTest().main()
