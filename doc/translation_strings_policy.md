...
This document provides guidelines for internationalization of the INDIANCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `indiancoin_en.ts` remains unchanged.
