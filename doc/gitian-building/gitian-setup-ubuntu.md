...
The build script we'll be using is contained in the INDIANCOIN github repository ([contrib/gitian-build.py](https://github.com/indiancoin-project/indiancoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the INDIANCOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/INDIANCOIN-Project/INDIANCOIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, indiancoin-detached-sigs, and indiancoin GitHub repos.
