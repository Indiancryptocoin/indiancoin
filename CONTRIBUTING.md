Contributing to INDIANCOIN Core
============================

The INDIANCOIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/indiancoin-project/indiancoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the INDIANCOIN Core project, and is not to be
confused with overall INDIANCOIN Network Protocol consensus changes.

Whether a pull request is merged into INDIANCOIN Core rests with the project merge
...
Patches that change INDIANCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the INDIANCOIN consensus, it must have been
...
The project leader is the release manager for each INDIANCOIN Core release.
