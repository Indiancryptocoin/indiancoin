// Copyright (c) 2017-2018 The INDIANCOIN developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef INDIANCOIN_ZINDWALLET_H
#define INDIANCOIN_ZINDWALLET_H
...
public:
    CzINDWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZIND(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZIND(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
