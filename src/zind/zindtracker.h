...
#ifndef INDIANCOIN_ZINDTRACKER_H
#define INDIANCOIN_ZINDTRACKER_H
...
public:
    CzINDTracker(std::string strWalletFile);
    ~CzINDTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzINDWallet* zINDWallet = NULL);
...
#endif //INDIANCOIN_ZINDTRACKER_H
