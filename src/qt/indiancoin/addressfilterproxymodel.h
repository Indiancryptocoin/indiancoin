...
#ifndef INDIANCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define INDIANCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //INDIANCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
