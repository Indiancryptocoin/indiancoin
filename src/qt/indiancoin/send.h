...
#include "qt/indiancoin/contactsdropdown.h"
#include "qt/indiancoin/sendmultirow.h"
#include "qt/indiancoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(INDIANCOINGUI* parent);
    ~SendWidget();
...
private slots:
    void onINDSelected(bool _isIND);
    void onSendClicked();
...
private:
    ...
    bool sendZind(QList<SendCoinsRecipient> recipients);
