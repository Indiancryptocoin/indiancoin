...
#include "qt/indiancoin/forms/ui_masternodeswidget.h"
#include "qt/indiancoin/qtutils.h"
#include "qt/indiancoin/mnrow.h"
#include "qt/indiancoin/mninfodialog.h"

#include "qt/indiancoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(INDIANCOINGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 10000)){
            inform(tr("Not enough balance to create a masternode, 10,000 IND required."));
            return;
        }
        showHideOp(true);
