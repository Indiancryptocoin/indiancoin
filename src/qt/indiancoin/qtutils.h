...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, INDIANCOINGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, INDIANCOINGUI *gui, double posX = 3);
