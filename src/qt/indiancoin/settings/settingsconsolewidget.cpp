...
#include "qt/indiancoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/indiancoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(INDIANCOINGUI* _window, QWidget *parent) :
