...
#include "qt/indiancoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/indiancoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(INDIANCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to INDIANCOINGUI::handleRestart()
