...
#include "qt/indiancoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/indiancoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(INDIANCOINGUI* _window, QWidget *parent) :
