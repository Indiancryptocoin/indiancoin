...
#include "qt/indiancoin/settings/settingsnetworkwidget.h"
#include "qt/indiancoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/indiancoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(INDIANCOINGUI* _window, QWidget *parent) :
