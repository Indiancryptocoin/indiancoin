...
#include "qt/indiancoin/forms/ui_receivewidget.h"
...
#include "qt/indiancoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(INDIANCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive IND."));
