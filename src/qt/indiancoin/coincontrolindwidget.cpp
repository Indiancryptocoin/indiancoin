...
#include "qt/indiancoin/coincontrolindwidget.h"
#include "qt/indiancoin/forms/ui_coincontrolindwidget.h"

CoinControlIndWidget::CoinControlIndWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlIndWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select IND Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("IND");
    ...
    ui->labelValueAfter->setText("0.00 IND");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 IND");
    ui->labelValueFee->setText("0.00 IND");
...
CoinControlIndWidget::~CoinControlIndWidget()
{
    delete ui;
}
