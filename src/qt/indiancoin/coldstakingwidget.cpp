...
#include "qt/indiancoin/forms/ui_coldstakingwidget.h"
#include "qt/indiancoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/indiancoin/requestdialog.h"
#include "qt/indiancoin/tooltipmenu.h"
#include "qt/indiancoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(INDIANCOINGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your INDs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept IND delegation / Delegate IND"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select IND outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 IND" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
