...
#include "config/indiancoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalInd = 0;
    qint64 totalZind = 0;
    QList<qreal> valuesInd;
    QList<qreal> valueszInd;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(INDIANCOINGUI* _window);
    ~DashboardWidget();
