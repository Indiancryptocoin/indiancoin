...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("INDIANCOIN Core"),
     ...
     * override -datadir in the indiancoin.conf file in the default data directory
     * (to be consistent with indiancoind behavior)
     */
