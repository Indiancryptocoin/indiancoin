...
/** Utility functions used by the INDIANCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render INDIANCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZind = false);
...
// Parse "indiancoin:" URI into recipient object, return true on successful parsing
