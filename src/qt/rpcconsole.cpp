                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzINDPathCustom = GetArg("-zindbackuppath", "");
    ...
    if(!strzINDPathCustom.empty()) {
        ui->wallet_customzindbackuppath->setText(QString::fromStdString(strzINDPathCustom));
        ui->wallet_customzindbackuppath_label->setVisible(true);
        ui->wallet_customzindbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzINDPathCustom.empty()) && nCustomBackupThreshold > 0) {
