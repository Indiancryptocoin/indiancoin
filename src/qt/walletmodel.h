...
#ifndef INDIANCOIN_QT_WALLETMODEL_H
#define INDIANCOIN_QT_WALLETMODEL_H
...
/** Interface to INDIANCOIN wallet from Qt view code. */
...
#endif // INDIANCOIN_QT_WALLETMODEL_H
