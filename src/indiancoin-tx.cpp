...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IndianCoin Core indiancoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  indiancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded indiancoin transaction") + "\n" +
                               "  indiancoin-tx [options] -create [commands]   " + _("Create hex-encoded indiancoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded indiancoin transaction
