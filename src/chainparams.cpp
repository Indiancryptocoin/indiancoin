...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("1c9121bf9329a6234bfd1ea2d91515f19cd96990725265253f4b164283ade5dd")); //!< First v7 block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51472;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // INDIANCOIN starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 200;
        nIndianCoinBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nIndianCoinBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        nModifierUpdateBlock = 1;
        nZerocoinStartHeight = 210;
        nZerocoinStartTime = 1583793663; 
        nBlockEnforceSerialRange = 212; 
        nBlockRecalculateAccumulators = 211; 
        nBlockFirstFraudulent = 1; 
        nBlockLastGoodCheckpoint = 64;
        nBlockEnforceInvalidUTXO = 1; 
        nInvalidAmountFiltered = 0*COIN; 
        nBlockZerocoinV2 = 250; 
        nBlockDoubleAccumulated = 255;
        nEnforceNewSporkKey = 1582720349;
        nRejectOldSporkKey = 1582710349; 
        nBlockStakeModifierlV2 = 262;
        nBIP65ActivationHeight = 260;
        // Activation height for TimeProtocolV2, Blocks V7 and newMessageSignatures
        nBlockTimeProtocolV2 = 270;
        ...
        // Blocks v7
        nBlockLastAccumulatorCheckpoint = 214;
        nBlockV7StartHeight = nBlockTimeProtocolV2;

        // Fake Serial Attack
        nFakeSerialBlockheightEnd = 275;
        ...
        vSeeds.push_back(CDNSSeedData("149.28.93.178", "149.28.93.178"));
        vSeeds.push_back(CDNSSeedData("66.42.99.28", "66.42.99.28"));
        vSeeds.push_back(CDNSSeedData("45.32.73.38", "45.32.73.38"));
        vSeeds.push_back(CDNSSeedData("45.63.61.250", "45.63.61.250"));
        vSeeds.push_back(CDNSSeedData("149.28.81.19", "149.28.81.19"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zind to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nIndianCoinBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nIndianCoinBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "indiancoin-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "indiancoin-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("warrows.dev", "testnet.dnsseed.indiancoin.warrows.dev"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet indiancoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet indiancoin script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet indiancoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet indiancoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet indiancoin BIP44 coin type is '1' (All coin's testnet default)
