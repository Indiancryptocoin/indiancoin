...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* INDIANCOIN features */
        {"indiancoin", "listmasternodes", &listmasternodes, true, true, false},
        {"indiancoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"indiancoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"indiancoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"indiancoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"indiancoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"indiancoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"indiancoin", "masternodedebug", &masternodedebug, true, true, false},
        {"indiancoin", "startmasternode", &startmasternode, true, true, false},
        {"indiancoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"indiancoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"indiancoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"indiancoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"indiancoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"indiancoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"indiancoin", "preparebudget", &preparebudget, true, true, false},
        {"indiancoin", "submitbudget", &submitbudget, true, true, false},
        {"indiancoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"indiancoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"indiancoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"indiancoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"indiancoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"indiancoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"indiancoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"indiancoin", "checkbudgets", &checkbudgets, true, true, false},
        {"indiancoin", "mnsync", &mnsync, true, true, false},
        {"indiancoin", "spork", &spork, true, true, false},
        {"indiancoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzindseed", &getzindseed, false, false, true},
        {"zerocoin", "setzindseed", &setzindseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzind", &searchdzind, false, false, true},
        {"zerocoin", "dzindstate", &dzindstate, false, false, true},
...
{
    return "> indiancoin-cli " + methodname + " " + args + "\n";
}
