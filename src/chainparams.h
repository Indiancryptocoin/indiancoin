 ...
 * INDIANCOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int IndianCoinBadBlockTime() const { return nIndianCoinBadBlockTime; }
    int IndianCoinBadBlocknBits() const { return nIndianCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nIndianCoinBadBlockTime;
    unsigned int nIndianCoinBadBlocknBits;
