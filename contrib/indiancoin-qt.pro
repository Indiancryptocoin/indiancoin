...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/indiancoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/indiancoin-cli.cpp \
           src/indiancoin-tx.cpp \
           src/indiancoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/indiancoin.qrc src/qt/indiancoin_locale.qrc

TRANSLATIONS += src/qt/locale/indiancoin_bg.ts \
                src/qt/locale/indiancoin_de.ts \
                src/qt/locale/indiancoin_en.ts \
                src/qt/locale/indiancoin_es.ts \
                src/qt/locale/indiancoin_fi.ts \
                src/qt/locale/indiancoin_fr.ts \
                src/qt/locale/indiancoin_it.ts \
                src/qt/locale/indiancoin_ja.ts \
                src/qt/locale/indiancoin_pl.ts \
                src/qt/locale/indiancoin_pt.ts \
                src/qt/locale/indiancoin_ru.ts \
                src/qt/locale/indiancoin_sk.ts \
                src/qt/locale/indiancoin_sv.ts \
                src/qt/locale/indiancoin_vi.ts \
                src/qt/locale/indiancoin_zh_CN.ts \
                src/qt/locale/indiancoin_zh_TW.ts
