...
This means one can have an always-on indiancoind instance running, and another local indiancoind/indiancoin-qt instance which connects to this node and receives blocks from it.
